...
class PemasanganACAdapter(
    private val items: MutableList<PemasanganAC>
) : RecyclerView.Adapter<PemasanganACAdapter.VH>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_pemasangan_ac, parent, false)
        return VH(v)
    }
    ...
    fun replaceAll(newItems: List<PemasanganAC>) {
